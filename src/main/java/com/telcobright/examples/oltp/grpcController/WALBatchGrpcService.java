...
public class WALBatchGrpcService extends WALBatchServiceGrpc.WALBatchServiceImplBase {
    ...
    public void executeWALBatch(WALBatchRequest request, StreamObserver<WALBatchResponse> responseObserver) {
        ...
        List<com.telcobright.examples.oltp.grpc.wal.WALEntry> protoEntries = request.getEntriesList();
    ...
    private WALEntryBatch convertProtoToWALBatch(WALBatchRequest protoRequest) {
        ...
        for (com.telcobright.examples.oltp.grpc.wal.WALEntry protoEntry : protoRequest.getEntriesList()) {
     ...
     */
    private WALEntry convertProtoToWALEntry(com.telcobright.examples.oltp.grpc.wal.WALEntry protoEntry) {
