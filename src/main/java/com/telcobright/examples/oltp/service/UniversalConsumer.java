...
import com.telcobright.examples.oltp.queue.chronicle.ConsumerToQueue;
...
public class UniversalConsumer implements Runnable, ConsumerToQueue<Object> {
    ...
    private Class<?> getEntityClass(String tableName) {
        ...
        switch (tableName.toLowerCase()) {
            case "packageaccount":
                return com.telcobright.examples.oltp.entity.PackageAccount.class;
            case "packageaccountreserve":
                return com.telcobright.examples.oltp.entity.PackageAccountReserve.class;
            default:
