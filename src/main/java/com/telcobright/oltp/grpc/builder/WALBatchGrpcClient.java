...
public class WALBatchGrpcClient {
    ...
    private WALBatchRequest convertToProtoRequest(WALEntryBatch walBatch) {
        ...
        for (int i = 0; i < walBatch.size(); i++) {
            ...
            com.telcobright.oltp.grpc.wal.WALEntry protoEntry = convertToProtoEntry(entry);
     ...
     */
    private com.telcobright.oltp.grpc.wal.WALEntry convertToProtoEntry(WALEntry walEntry) {
        com.telcobright.oltp.grpc.wal.WALEntry.Builder entryBuilder = 
            com.telcobright.oltp.grpc.wal.WALEntry.newBuilder()
