package com.telcobright.oltp.mapper;
...
public class EntityProtoMapper {
     ...
     */
    public static com.telcobright.oltp.grpc.batch.PackageAccount toProto(PackageAccount entity) {
        var builder = com.telcobright.oltp.grpc.batch.PackageAccount.newBuilder()
     ...
     */
    public static com.telcobright.oltp.grpc.batch.PackageAccountReserve toProto(PackageAccountReserve entity) {
        var builder = com.telcobright.oltp.grpc.batch.PackageAccountReserve.newBuilder()
            .setId(entity.getId() != null ? entity.getId() : 0L)
     ...
     */
    public static com.telcobright.oltp.grpc.batch.PackageAccountReserveDelta toProto(PackageAccountReserveDelta entity) {
        var builder = com.telcobright.oltp.grpc.batch.PackageAccountReserveDelta.newBuilder()
            .setDbName(entity.getDbName() != null ? entity.getDbName() : "")
     ...
     */
    public static PackageAccount fromProto(com.telcobright.oltp.grpc.batch.PackageAccount proto) {
     ...
     */
    public static PackageAccountReserve fromProto(com.telcobright.oltp.grpc.batch.PackageAccountReserve proto) {
