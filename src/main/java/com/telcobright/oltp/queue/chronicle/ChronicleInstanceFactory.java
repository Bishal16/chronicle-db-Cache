...
public class ChronicleInstanceFactory {
    ...
    public ChronicleInstanceFactory(
        ...
        // ✅ Subscribe consumers provided by ConsumerFactory
        for (ConsumerToQueue consumer : consumerFactory.createConsumers(chronicleInstance)) {

            System.out.println("🚀 Subscribing consumer...");
            this.chronicleInstance.subscribe(consumer);
